    ...
    <div className="fixed bottom-0 inset-x-0 z-50 bg-[#FFF6D6] text-black border-t border-black/10">
      <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col md:flex-row gap-3 items-center justify-between">
        ...
        <div className="flex gap-2">
          <button onClick={accept} className="px-4 py-1 rounded-md bg-[#C9A23F] text-white text-sm">Accept</button>
          <button onClick={decline} className="px-4 py-1 rounded-md bg-gray-200 text-black text-sm">Decline</button>
        </div>
      </div>
    </div>
  )
